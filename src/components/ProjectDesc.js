        ...
        <div className="container">
          <div className={`row justify-content-center ${width > height ? "ph-w2" : "ph-h2"}`}>
            <div className="col-lg-8 col-md-10 text-center">
              <h2 className={`fl fc-o ${width > height ? "fs-w-60" : "fs-h-60"}`}>{project.heading_1}</h2>
              <p className={`fl fc-g ${width > height ? "fs-w-20 pv-w1" : "fs-h-20 pv-h1"}`}>{project.desc_1}</p>
            </div>
          </div>
            ...
            <div className="col-lg-4 col-sm-6">
              <div className={`single-expe text-center ${width > height ? "pv-w1" : "pv-h1"}`}>
                ...
                <div className={`${width > height ? "grid-icon-w" : "grid-icon-h"}`}>
                  <h3 className={`fl fc-o ${width > height ? "fs-w-60" : "fs-h-60"}`}>{project.type}</h3>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-sm-6">
              <div className={`single-expe text-center ${width > height ? "pv-w1" : "pv-h1"}`}>
                ...
                <div className={`${width > height ? "grid-icon-w" : "grid-icon-h"}`}>
                  <h3 className={`fl fc-o ${width > height ? "fs-w-60" : "fs-h-60"}`}>{project.location}</h3>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-sm-6">
              <div className={`single-expe text-center ${width > height ? "pv-w1" : "pv-h1"}`}>
                ...
                <div className={`${width > height ? "grid-icon-w" : "grid-icon-h"}`}>
                  <h3 className={`fl fc-o ${width > height ? "fs-w-60" : "fs-h-60"}`}>{project.plan}</h3>
                </div>
              </div>
            </div>
